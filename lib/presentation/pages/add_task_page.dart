...
import 'package:course_tusk_app/data/source/task_source.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  addNewTask() {
    ...
    TaskSource.add(
      ...
      if (success) {
        AppInfo.success(context, "Success Tambah Jadwal Menu Harian Baru");
      } else {
        AppInfo.failed(context, "Failed Tambah Jadwal Menu Harian Baru");
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tambah Jadwal Menu Harian'),
        centerTitle: true,
      ),
      body: ListView(
